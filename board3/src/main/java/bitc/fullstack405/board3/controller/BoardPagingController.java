...
public class BoardPagingController {
    ...
    // @RequestParam의 추가 옵션 중 required=false 사용 시, 지정된 값이 입력되지 않아도 오류가 발생하지 않음
    ...
    public ModelAndView selectBoardListPaging(@RequestParam(required = false, defaultValue = "1", value = "pageNum") int pageNum) throws Exception {
        ...
        */
        ...
        // PageInfo: PageHelper에서 제공하는 데이터 타입, HashMap가 비슷한 데이터 타입
        // 첫번째 매개변수: 서비스를 사용하여 DB에서 데이터를 가져오는 메서드
