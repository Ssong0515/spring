...
//    영속성 전이: JPA로 관계 설정이 되어 있는 데이터베이스 사용 시, 기준이 되는 메인 Entity의 데이터가 변경이 될 경우
//    서브 Entity의 데이터도 함께 수정 되는 것
//    cascade: 영속성 전이 설정을 위한 속성
//    All: 모든 영속 상태 변경에 대해서 영속성 전이를 적용
//    PERSIST: Entity가 영속화 할 때, 연관된 Entity도 함께 영속화
...
//    DETACH: Entity를 영속성 컨테스트에서 제외하면 연관된 Entity도 제외
